...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn('[&_tr]:border-b select-none', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-8 px-2.5 text-left align-middle font-semibold text-slate-700 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
